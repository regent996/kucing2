  ...
  <div class="content-wrapper">
    ...
    <!-- Banner -->
        ...
        <div class="container-fluid" style="    ">
                    ...
                    $sql = "SELECT typeofcat.id,typeofcat.image,typeofcat.name,typeofcat.age,vaccine.vaccine,vaccine.nextvaccine FROM typeofcat INNER JOIN vaccine ON typeofcat.id = vaccine.id ";
                    $date = date('Y-m-d');
                            ...
                            echo "<table class='table table-hover'>";
                                echo "<thead-dark>";
                                    echo "<tr>";
                                        ...
                                        echo "<th>Age</th>";
                                        echo "<th>Last Vaccine</th>";
                                        echo "<th>Next Vaccine</th>";
                                        echo "<th>Action</th>";
                                    echo "</tr>";
                                echo "</thead>";
