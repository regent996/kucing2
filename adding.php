...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    } elseif(!filter_var(trim($_POST["type"]), FILTER_VALIDATE_REGEXP, array("options"=>array("regexp"=>"/^[a-zA-Z'-.\s ]+$/")))){
    ...
    if(empty($type_err)){
        ...
        $sql = "INSERT INTO catlist (type) VALUES (?)";
...
<li class="nav-item has-treeview">
  ...
  <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Adding New Cat type on dropdown</h2>
                    </div>
                    <p>Please enter type of cat you want.</p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group <?php echo (!empty($type_err)) ? 'has-error' : ''; ?>">
                            <label>Type of Cat</label>
                            <input style="width: 50%;" type="text" name="type" class="form-control" value="<?php echo $type; ?>">
        ...
        <div class="page-header">
                        <h2>Cat Type Already Inserted</h2>
                    </div>
            <?php
