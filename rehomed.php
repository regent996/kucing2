...
<li class="nav-item has-treeview">
  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid" style="    ">
                    ...
                    $sql = "SELECT * FROM typeofcat WHERE status='Rehomed' ";
                    $date = date('Y-m-d');
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='update3.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                              echo "<a href='delete3.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
