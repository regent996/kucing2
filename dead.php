  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid" style="    ">
                    <div class="page-header clearfix">
                        <h2 style="color: rgb(23,231,246);" class="pull-left">Dead Cats</h2>
                    </div>
                    ...
                    $sql = "SELECT * FROM typeofcat WHERE status='Dead' ";
                    $date = date('Y-m-d');
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='update4.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                              echo "<a href='delete4.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
